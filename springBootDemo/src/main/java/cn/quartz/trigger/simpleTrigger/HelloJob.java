...
public class HelloJob implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        Util.print("第" + count + "次执行job," + "时间:" + DateBuilder.newDate().toString());
        ...
        Util.print(mergedJobDataMap.getString("message"));
        Util.print(mergedJobDataMap.get("message"));//两种写法
        Util.printMap(mergedJobDataMap);
    }
