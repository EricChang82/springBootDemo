...
public class Sheet {
    ...
    /**
     *
     * @param sheetNo start 1
     * @param headLineMun start 0
     */
    ...
    public Sheet(int sheetNo, String sheetName, Class<? extends BaseRowModel> clazz) {
        this.sheetNo = sheetNo;
        this.sheetName = sheetName;
        this.clazz = clazz;
    }

    public Sheet(int headLineMun, int sheetNo, String sheetName) {
        this.headLineMun = headLineMun;
        this.sheetNo = sheetNo;
        this.sheetName = sheetName;
    }
